...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From", "English","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu","Tamil"};
    String[] toLanguages = {"To", "English","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu","Tamil"};
